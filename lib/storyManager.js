...
export const fetchUserStoryline = (checkpoint, stories) => {
  try {
    ...
    if (typeof userCheckpoint.chapter_id !== 'number' || 
      ...
      console.error('Invalid checkpoint structure:', userCheckpoint);
      console.error('Checkpoint:', userCheckpoint.user_id, 'Chapter:', userCheckpoint.chapter_id, 'Chunk:', userCheckpoint.last_chunk_id);
